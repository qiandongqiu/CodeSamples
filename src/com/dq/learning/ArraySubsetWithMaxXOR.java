...
// https://www.geeksforgeeks.org/gocc14-googles-online-coding-challenge-new-grad-india/?ref=lbp

//solution: https://www.geeksforgeeks.org/find-maximum-subset-xor-given-set/

public class ArraySubsetWithMaxXOR {
	...
	static int maxSubarrayXOR(int set[], int n) {
		...
		for (int i = INT_BITS - 1; i >= 0; i--) {
			...
			System.out.println();
			System.out.println("i="+i+"; max index="+index);
	...
	static void printArray(int[] set) {
			System.out.println();
			for(int item:set) {
